...
> 📚 Full documentation in [`docs/`](docs/) · 🔒 security scan in [`docs/scan/scan-report.md`](docs/scan/scan-report.md) · 🎬 System overview: [briefing](media/system-overview.md) · [deck](media/bulletproof-compliance-jobs-deck.pdf) · [video](media/system-overview.mp4).
